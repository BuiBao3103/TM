...
namespace TM.Migrations
{
    ...
    [Migration("20250629215112_AddGroupPassenger")]
    partial class AddGroupPassenger
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TM.Models.Entities.Passenger", b =>
                {
                    ...
                    b.Property<int?>("PassengerGroupId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TM.Models.Entities.PassengerGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("Id")
                        .HasName("PK__PassengerGroup__3214EC07");
                    ...
                    b.ToTable("PassengerGroup", (string)null);
                });
            ...
            modelBuilder.Entity("TM.Models.Entities.Passenger", b =>
                {
                    ...
                    b.HasOne("TM.Models.Entities.PassengerGroup", "PassengerGroup")
                        .WithMany("Passengers")
                        .HasForeignKey("PassengerGroupId")
            ...
            modelBuilder.Entity("TM.Models.Entities.Account", b =>
                {
                    ...
                    b.Navigation("PassengerGroupsCreated");

                    b.Navigation("PassengerGroupsModified");
